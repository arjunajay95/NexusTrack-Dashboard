...
const task_empty = document.getElementById("empty-tasks");
...
function task_card(tasks_list, task_container) {
  ...
  if (tasks_list.length === 0) {
    ...
    task_empty.classList.add("hidden");
...
function mobile_menu_close() {
  ...
  hamburger_toggle.children[0].classList.remove("hidden");
  hamburger_toggle.children[1].classList.add("hidden");
}
...
// Open / close mobile menu with hamburger icon click
...
overlay.addEventListener("click", mobile_menu_close);
